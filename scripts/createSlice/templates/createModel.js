...
module.exports = async (layer, sliceName) => {
  ...
  const createModelStructure = async () => {
    try {
      ...
      console.log(
        `Не вдалось створити model сегмент для слайсу ${sliceName}`,
        e,
      );
    }
  };
  ...
  const createReduxSlice = async () => {
    try {
      ...
      console.log('Не вдалось створити редакс слайс', e);
    }
  };
  ...
  const createSchemaType = async () => {
    try {
      ...
      console.log('Не вдалось створити тип схеми стейту', e);
    }
  };
